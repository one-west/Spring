...
<section>
  ...
  <div id="section_wrap">
    ...
    <div class="modify_book_form">
      ...
      <form action="<c:url value='/book/admin/modifyBookConfirm' />" name="modify_book_form" method="post"
        ...
        <input type="text" name="publishYear" value="${bookVo.publishYear}" placeholder="INPUT BOOK PUBLISH YEAR.">
        <br>
