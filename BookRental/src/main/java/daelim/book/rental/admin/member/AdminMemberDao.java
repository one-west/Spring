...
public class AdminMemberDao {
    ...
    public int insertAdminAccount(AdminMemberVo adminMemberVo) {
        ...
        System.out.println(adminMemberVo.getId());
    ...
    public boolean exsitAdminAccount(String id) {
    ...
    public AdminMemberVo selectAdmin(int no) {
        System.out.println("[AdminMemberDao] selectAdmin(int)");
    ...
    public AdminMemberVo selectAdmin(String id, String name, String email) {
        System.out.println("[AdminMemberDao] selectAllAdmin(String id, String name, String email)");
    ...
    public int updateAdminAccount(AdminMemberVo adminMemberVo) {
        ...
        String sql = "UPDATE TB_ADMIN_ACCOUNT SET name=?, gender=?, part=?, position=?, email=?, phone=?, modDate=now() WHERE no=?";
        int result = -1;
        try {
            result = jdbcTemplate.update(sql, adminMemberVo.getName(), adminMemberVo.getGender(), adminMemberVo.getPart(), adminMemberVo.getPosition(), adminMemberVo.getEmail(), adminMemberVo.getPhone(), adminMemberVo.getNo());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
